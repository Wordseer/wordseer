...
Ext.define('WordSeer.model.LayoutPanelModel', {
	...
	constructor: function(cfg) {
		...
		this.JStore = Ext.create('WordSeer.store.FrequentWordsStore', {pos:'J'});
		this.VStore = Ext.create('WordSeer.store.FrequentWordsStore', {pos:'V'});
		this.NStore = Ext.create('WordSeer.store.FrequentWordsStore', {pos:'N'});
