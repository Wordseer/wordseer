...
class GetDistribution(View):
    ...
    def get_dimensions(self, narrative_id):
    ...
    def get_grammatical_ocurrences(self, narrative_id, dependency_id):
...
wordseer.add_url_rule("/getdistribution",
    view_func=GetDistribution.as_view("get-distribution"))
